...
public interface SentimentAnalyzer {
    ...
    /**
     * @param word the word to get sentiment on.
    ...
    /**
     * @param word the word to get the frequency of in all reviews.
     ...
     * @throws IllegalArgumentException, if review is null, empty or blank,
